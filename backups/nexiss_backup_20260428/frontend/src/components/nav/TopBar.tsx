...
export default function TopBar({ isAdmin }: TopBarProps) {
  ...
  return (
    <header className="h-20 flex items-center justify-between px-8 bg-dark-bg/50 backdrop-blur-md border-b border-white/5 sticky top-0 z-30">
      ...
      <div className="flex items-center gap-8">
        <div className="relative">
          {!isAdmin && orgs.length > 0 && (
            <button
              ...
              className="flex items-center gap-3 px-4 py-2 rounded-xl bg-white/5 border border-white/10 text-sm font-medium text-gray-200 hover:bg-white/10 transition-all shadow-inner"
            >
        ...
        {!isAdmin && (
          <div className="hidden md:flex items-center gap-3 px-4 py-2 w-80 rounded-xl bg-white/5 border border-white/10 text-gray-500 cursor-text hover:bg-white/10 transition-all">
            <Search size={16} />
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3 pl-2">
          <div className="flex flex-col items-end hidden sm:flex">
            ...
            <span className="text-[10px] text-gray-500 font-mono uppercase tracking-tighter">Identity Verified</span>
          </div>
